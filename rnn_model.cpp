...
void rnn_model(intype signals[n][m], ftype weights_in[m][m], ftype biases_in[m], ftype w_hidd2[m][m], ftype b_hidd2[m],
		...
		//for mogrifier R and Q
		ftype mogrifier_weights[mogrify_steps][m],ftype mogrifier_bias_even[mogrify_steps],ftype mogrifier_bias_odd[mogrify_steps][m]
...
#pragma HLS allocation instances=rnn_LSTM limit=1 function
    ...
    rnn_mogLSTM(w_all, b_all, h, c, inputs, mogrifier_weights, mogrifier_bias_even, mogrifier_bias_odd);
